...
<script type="text/javascript">
    var minplay = <?php echo json_encode($numplayers); ?>;
</script>
<script src="./js/witchhunt.js"></script>

<!DOCTYPE html>
<html>
  <head>
      <!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-118525820-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-118525820-1');
</script>
